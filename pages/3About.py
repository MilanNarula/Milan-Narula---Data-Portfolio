...
with col1:
    ...
    st.markdown("""
            <div class="project-card-about mt-2">
...
with col2:
        st.markdown("""
            <div class="project-card-about">
                ...
                <div class="project-card-about mt-4">
...
<div class="container mt-5">
    <div class="f1-hero text-center">
        ...
        <div class="d-flex gap-3 justify-content-center align-items-center flex-wrap">
            <a href="mailto:your.email@gmail.com" class="btn btn-outline-light">
